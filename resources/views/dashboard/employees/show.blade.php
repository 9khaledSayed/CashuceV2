        ...
        <div class="kt-portlet__body kt-portlet__body--fit">
            <div class="kt-grid  kt-wizard-v1 kt-wizard-v1--white droid_font" id="kt_contacts_add" data-ktwizard-state="step-first">
                ...
                <div class="kt-grid__item kt-grid__item--fluid kt-wizard-v1__wrapper">
                    ...
                    <form class="kt-form" style="width: 65%" id="kt_contacts_add_form">
                                                    ...
                                                    <div class="kt-section__body">
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-lg-3">
                                                                ...
                                                                <input name="tname_ar" class="form-control" disabled="disabled" type="text"  value="{{$employee->tname_ar}}">
                                                            </div>
                                                            <div class="col-lg-3">
                                                                <label>{{__('Fourth Name Arabic')}} *</label>
                                                                <input name="lname_ar" class="form-control" disabled="disabled" type="text"  value="{{$employee->lname_ar}}">
                                                            </div>
                                                        </div>
                                                        <div class="form-group row">
                                                            <div class="col-lg-3">
                                                            ...
                                                            <div class="col-lg-3">
                                                                ...
                                                                <input name="tname_en" class="form-control" disabled="disabled" type="text"  value="{{$employee->tname_en}}">
                                                            </div>
                                                            <div class="col-lg-3">
                                                                <label>{{__('Fourth Name English')}} *</label>
                                                                <input name="lname_en" class="form-control" disabled="disabled" type="text"  value="{{$employee->lname_en}}">
                                                            </div>
                                                        </div>
                                                        <div class="form-group row">
                                                            <div class="col-lg-12">
                                                        ...
                                                        <div class="form-group row">
                                                            <div class="col-lg-6">
                                                                ...
                                                                <div class="kt-radio-list mx-auto text-center">
                                                                    <label class="kt-radio kt-radio--bold kt-radio--brand">
                                                                        <input type="radio" name="marital_status" disabled="disabled" value="0"  @if($employee->marital_status == 0) checked @endif>
                                                                        {{__('Single')}}
                                                                        <span></span>
                                                                    </label>
                                                                    <label class="kt-radio kt-radio--bold kt-radio--brand">
                                                                        <input type="radio" name="marital_status" disabled="disabled" value="1"  @if($employee->marital_status == 1) checked @endif>
                                                                        {{__('Married')}}
                                                                        <span></span>
                                                                    </label>
                                                                </div>
                                                            ...
                                                            <div class="col-lg-6">
                                                                ...
                                                                <div class="kt-radio-list mx-auto text-center">
                                                                    <label class="kt-radio kt-radio--bold kt-radio--brand">
                                                                        <input type="radio" name="gender" disabled="disabled" value="0"  @if($employee->gender == 0) checked @endif>
                                                                        {{__('Male')}}
                                                                        <span></span>
                                                                    </label>
                                                                    <label class="kt-radio kt-radio--bold kt-radio--brand">
                                                                        <input type="radio" name="gender" disabled="disabled" value="1"  @if($employee->gender == 1) checked @endif>
                                                                        {{__('Female')}}
                                                                        <span></span>
                                                                    </label>
                                                                </div>
                                                    ...
                                                    <div class="kt-section__body">
                                                        ...
                                                        <div class="form-group row">
                                                            <div class="col-lg-4">
                                                                ...
                                                                <input name="id_num" class="form-control" disabled="disabled" type="text"  value="{{$employee->id_num}}">
                                                            </div>
                                                            <div class="col-lg-4">
                                                    ...
                                                    <div class="kt-section__body">
                                                        ...
                                                        <div class="form-group row">
                                                            <div class="col-lg-12">
                                                                ...
                                                                <input name="passport_num" class="form-control" disabled="disabled" type="text"  value="{{$employee->passport_num}}">
                                                            </div>
                                                        </div>
                                                        <div class="form-group row">
                                                            <div class="col-lg-4">
                                                            ...
                                                            <div class="col-lg-4">
                                                                ...
                                                                <input name="issue_place" class="form-control" disabled="disabled" type="text"  value="{{$employee->issue_place}}">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="kt-section__body">
                                                    ...
                                                    <div class="form-group row">
                                                        <div class="col-lg-6">
                                                            ...
                                                            <input name="phone" class="form-control" disabled="disabled" type="text"  value="{{$employee->phone}}">
                                                        </div>
                                                        <div class="col-lg-6">
                                                            <label>{{__('Email')}} *</label>
                                                            <input name="email" class="form-control" disabled="disabled" type="text"  value="{{$employee->email}}">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                    ...
                                                    <div class="kt-section__body">
                                                        ...
                                                        <div class="form-group row">
                                                            <div class="col-lg-12">
                                                                ...
                                                                <select disabled="disabled" name="contract_type" class="form-control kt-selectpicker" title="Choose" >
                                                            ...
                                                            <div class="kt-radio-list">
                                                                @foreach($workShifts as $workShift)
                                                                    <label class="kt-radio kt-radio--tick kt-radio--brand">
                                                                        <input
                                                                                type="radio" disabled="disabled" name="work_shift_id"
                                                                                value="{{$workShift->id}}"
                                                    ...
                                                    <div class="kt-section__body">
                                                        ...
                                                        <div class="form-group row">
                                                            <div class="col-lg-12">
                                                                ...
                                                                <input name="salary" class="form-control" disabled="disabled" type="text"  value="{{$employee->salary}}">
                                                            </div>
                                                        </div>
                                                        <div class="form-group row">
                                                            <div class="form-group">
                                                                    ...
                                                                    <div class="kt-checkbox-list">
                                                                        @foreach($allowances as $allowance)
                                                                            <label class="kt-checkbox kt-checkbox--bold  @if($allowance->type == 1) kt-checkbox--success @else kt-checkbox--danger @endif ">
                                                                                <input disabled="disabled" name="allowance[]" @if($employee->allowances->contains($allowance)) checked @endif value="{{$allowance->id}}" type="checkbox">
                                                                                {{$allowance->name()}}
