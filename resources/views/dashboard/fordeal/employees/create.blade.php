    ...
    <div class="kt-subheader   kt-grid__item" id="kt_subheader">
        <div class="kt-container  kt-container--fluid ">
            ...
            <div class="kt-subheader__toolbar">
                ...
                <a href="{{route('dashboard.employees.index', 'fordeal')}}" class="btn btn-secondary">
                    {{__('Back')}}
                </a>
            </div>
        </div>
        ...
        <div class="kt-portlet__body kt-portlet__body--fit">
            <div class="kt-grid  kt-wizard-v1 kt-wizard-v1--white droid_font" id="kt_contacts_add" data-ktwizard-state="step-first">
                ...
                <div class="kt-grid__item kt-grid__item--fluid kt-wizard-v1__wrapper">
                    ...
                    <form action="{{route('dashboard.employees.store', 'fordeal')}}" method="post" class="kt-form" style="width: 65%" id="kt_contacts_add_form" >
                    @csrf
                                                    ...
                                                    <div class="kt-section__body">
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-lg-3">
                                                                ...
                                                                <input name="tname_ar" class="form-control" type="text">
                                                            </div>
                                                            <div class="col-lg-3">
                                                                <label>{{__('Fourth Name Arabic')}} *</label>
                                                                <input name="lname_ar" class="form-control" type="text">
                                                            </div>
                                                        </div>
                                                        <div class="form-group row">
                                                            <div class="col-lg-3">
                                                            ...
                                                            <div class="col-lg-3">
                                                                ...
                                                                <input name="tname_en" class="form-control" type="text">
                                                            </div>
                                                            <div class="col-lg-3">
                                                                <label>{{__('Fourth Name English')}} *</label>
                                                                <input name="lname_en" class="form-control" type="text">
                                                            </div>
                                                        </div>
                                                        <div class="form-group row">
                                                            <div class="col-lg-6">
