        ...
        var datatable = $('.kt-datatable').KTDatatable({
            ...
            data: {
                ...
                source: {
                    read: {
                        method: 'GET',
                        url: '/dashboard/employees_special',
                    },
                },
                pageSize: 10,
                serverPaging: true,
            ...
            columns: [
                ...
                },
                {
                    ...
                    template:function (row){
                        return '<a href="/dashboard/employees_special/' + row.id + '">' + row.name + '</a>';
                    }
                }, {
                    field: 'job_number',
                        ...
                        return '\
		                  <div class="dropdown">\
		                      ...
		                      <div class="dropdown-menu dropdown-menu-right">\
		                          <a class="dropdown-item" href="/dashboard/employees_special/' + row.id + '/edit"><i class="la la-pencil-square-o"></i>' + locator.__('Edit Info') + '</a>\
		                          <a class="dropdown-item" href="/dashboard/employees_special/' + row.id + '"><i class="la la-eye"></i>' + locator.__('Show Info') + '</a>\
		                      </div>\
		                  </div>\
                        ';
                    }
